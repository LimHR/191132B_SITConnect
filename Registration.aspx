...
<script type="text/javascript">
        function validate() {
            ...
            if (str.length < 12) {
                ...
                document.getElementById("lbl_pwdcheckerhr").innerHTML = "Password require at least 1 lowercase";
                document.getElementById("lbl_pwdcheckerhr").style.color = "Red";
                return ("no_lowercase");
            }
...
<p>
    ...
    <p>
        <asp:Button ID="btn_submihr" runat="server" Text="Submit" onclick="btn_Submithr_Click" />
    </p>
</form>
